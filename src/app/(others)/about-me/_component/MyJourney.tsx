const MyJourney = () => {
  return (
    <div className="mt-10 md:mt-20">
      <div className="bg-purple-dark text-white md:ml-[15%] md:rounded-s-[60px] text-justify relative px-8 sm:pb-48">
        <h2
          //   className="text-4xl md:text-5xl  text-center pt-20 pb-10"
          className="static text-center pt-20 md:pt-0 md:absolute md:left-12 md:top-[550px] md:-rotate-90 text-4xl md:text-5xl "
          style={{ transformOrigin: "left" }}
        >
          My Teaching Journey:
        </h2>
        <div className="flex flex-col gap-5 max-w-3xl mx-auto py-10 md:ml-20">
          <p>
            In January 2013, I embarked on my professional journey as a Year 5
            Class Teacher at a private primary school in Lagos, Nigeria. The
            role presented a unique blend of challenges and exhilaration,
            especially as a new educator. My primary objective was to address
          ...
          <p>
            ...
            enabled me to deliver high-quality, engaging lessons and cater to
            the needs of both my higher-achieving and struggling students.
          </p>
          <p>
            In January 2017, I joined an International School in Lagos as part
            of a Graduate Teacher Trainee Program. This was my first exposure to
            the Early Years Foundation Stage (EYFS) Statutory Framework. The
            program involved hands-on training in classroom management, learner
            engagement and observation, progress tracking, and the creation of
            differentiated learning resources. This experience was
            transformative, igniting my passion for everything related to EYFS.
          </p>
          <p>
            Upon completing the training in April 2017, I was appointed as a
            Teaching Assistant, initially in a Nursery class for 3-4-year-olds,
            and subsequently for Reception (4-5-year-olds). In August 2018, I
            was promoted to the role of Class Teacher in the Nursery class.
          </p>
          <p>
            ...
            observations by senior leaders, all resulting in outstanding
            outcomes.
          </p>
          <p>
